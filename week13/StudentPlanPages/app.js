...
function buttonMessage(){
    let buttonText = document.querySelector("#ecors-button-manage");
    buttonText.textContent = "Manage study plan declaration and course reservation";
    buttonText.classList.add("ecors-button-manage");
}
buttonMessage();
    ...
    function renderRows(data) {
        ...
        data
            ...
            .forEach((plan) => {
                ...
                tdCode.classList.add("ecors-studyCode");
